...
An AI that extracts knowledge and co-relate information from multiple documents. 
"""
...
def main():
    st.header("Chat with Memory - Ask questions about your PDF documents")
    ...
    if query:
        ...
        if "upload_pdf" in query.lower():
            ...
            if active_document:
                ...
                st.write("Please select an uploaded document to continue the conversation.")
